        ...
        <div className="flex flex-col w-screen h-screen bg-gray-900 items-center justify-center">
            ...
            >
                ...
                <input
                    ...
                    required
                />
                <button className="text-white text-xl bg-gray-700 hover:bg-gray-600 active:bg-gray-700 rounded-xl px-6 py-1">Sign up</button>
                <p className="text-white text-xl">Already have an account? <a className="text-white text-xl  hover:underline" href="/login">Log in!</a></p>
            </form>
        </div>
    )
}