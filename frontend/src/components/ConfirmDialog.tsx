    ...
    return (
        <AlertDialog.Root>
            ...
            <AlertDialog.Portal>
                ...
                <AlertDialog.Content
                    className="
                        bg-gray-800 light:bg-gray-200 p-6 rounded-xl shadow-xl fixed
                ...
                >
                    ...
                    <div className="mt-4 flex justify-end gap-2">
                        <AlertDialog.Cancel asChild>
                            <button className="px-4 py-2 rounded bg-gray-600 light:bg-gray-400 hover:bg-gray-500 light:hover:bg-gray-300">
                                {cancelText}
                            </button>
                        </AlertDialog.Cancel>
